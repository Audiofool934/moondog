...
for (const expected of [
  ...
  "Every artist, track, and number on this page is made up.",
  "Year by year",
  "Listening Time Machine",
  'id="time-machine"',
  "<h3>Time</h3>",
  "4 of 4 years have a song",
  "its own biggest year",
  "at least 2 plays not skipped and 5 minutes",
  "not always when you found it",
  "Listening Pulse",
  "36 months with listening",
  "A blank cell means no history was kept for that month, not that you stopped listening.",
  "Coming Back to Life",
  "Music that came back",
  "Back after 180+ days away",
  "not proof you missed them",
  "<h3>Echoes</h3>",
  "Songs you played back to back",
  "2 or more in a row",
  "could be love, or repeat mode, or falling asleep",
  "Wish You Were Here",
  "The dark side of the moon",
  "What stayed. What changed.",
  "Artists across the years",
  "Year to year",
  "4 years, 2023 to 2026",
  "50% stayed",
  "Fictional archive preview",
  "Inside a listening stretch",
  "2,500 listening stretches",
  "42% contain 5 or more plays",
  "Records you went deep on",
  "11 tracks",
]) {
...
for (const expected of [
  ...
  "A fictional demo",
  "Fictional public profile",
  "Every artist, track, date, and number on this card is made up.",
  "Shine On",
  "Lately",
  "Most played",
]) {
